                      ...
                      <?php
                        if ($row['statusOne'] == 0 ) {
                          echo '<span class="badge bg-warning text-white mt-1 p-2"><i class="fa fa-exclamation-triangle"></i> PENDING </span>';
                            ...
                            echo '<span class="badge bg-danger text-white mt-1 p-2"><i class="bi bi-x-circle"></i> DECLINE </span>';
                          } else {
                          echo '<span class="badge bg-success p-2 text-white mt-1"><i class="fa fa-check-circle"></i> APPROVED </span>';
                        }
                      ?>
                    </td>
                    <td>
