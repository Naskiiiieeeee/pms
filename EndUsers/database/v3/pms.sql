...
(31, 'j.macapagal.cdm@gmail.com', '$2y$10$soNA0l3A5i6XzIlXYYZMi.4ZeZP3bObHM04lTZBYmGnbkCI23OfTu', 'Jonas Macapagal', NULL, NULL, 'Admin', 1, '2025-05-14');
...
--
ALTER TABLE `orderconfirmation`
  MODIFY `oc_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `request`
  MODIFY `r_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
