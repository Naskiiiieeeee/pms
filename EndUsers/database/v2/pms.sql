...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2025 at 06:26 PM
...
(19, 'A2', 'empIDempIDempID,empIDempIDempIDempIDempIDempID', '2,2', 'humblebeast1218@gmail.com', 1, '2025-05-18');
...
(33, 'A2', 'A1', 'humblebeast1218@gmail.com', 'empIDempIDempID', 'empIDempIDempID,empIDempIDempIDempIDempIDempID', '2,2', '', '2025-05-18', 'asdf', 1, '2025-05-18');
...
(41, 'A1', 'empIDempIDempID', 'empIDempIDempID', 'empIDempIDempID,empIDempIDempIDempIDempIDempID', 'empIDempIDempID,empIDempIDempIDempIDempIDempID', '2,2', '2025-05-18', '2025-05-18', '2025-05-18', 'humblebeast1218@gmail.com', 1, 1, NULL);
...
(33, 'fishcakejmm18@gmail.com', '$2y$10$sxOI/FeyD4AE7mjirbaO6eNzlnduJVSqvuvaBzmhXEafZJpZ8tASy', 'John Dale', NULL, 'BSU ALANGILAN', 'Admin', 1, '2025-05-18'),
(34, 'jonas.macapagal@pnm.edu.ph', '$2y$10$td9aH/n4PbvybMIBwd6dJewZ3TlN.eh29veRs2HSznoLWj8NPnZIe', 'Naskie', 'COLLEGE OF INDUSTRIAL TECHNOLOGY', 'BSU ALANGILAN', 'DepHead', 2, '2025-05-18');
...
--
ALTER TABLE `orderconfirmation`
  MODIFY `oc_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `o_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
