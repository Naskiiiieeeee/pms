...
if (isset($_POST['from']) && isset($_POST['to']) && isset($_POST['export_excel']) && $_POST['export_excel'] == "1") {
    ...
    header("Content-Disposition: attachment; filename=Order_report_" . date('YmdHis') . ".xls");
    ...
    $i = 1;
    $filterBetweenDates = "SELECT * FROM `orders` WHERE `datePosted` BETWEEN '$from' AND '$to'";
...
?>
<!-- Page Content  -->
<h2 class="mb-4">PMS Order Reports</h2>
