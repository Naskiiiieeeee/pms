                ...
                <tbody>
                  <?php 
                    ...
                    <tr>
                        ...
                        <?php
                            if ($row['statusOne'] == 0 ) {
                            echo '<span class="badge bg-secondary text-white p-2"><i class="fas fa-exclamation-triangle"></i> PENDING </span>';
                        ...
                        <td>
                            <a href="userviewunitRequest.php?ID=<?php echo $row['transactionCode'];?>" class="btn btn-primary text-white p-2 btn-sm  mx-2"><i class="fas fa-eye"></i> View</a>
                        </td>
                    </tr>
                  <?php }?>
                </tbody>
